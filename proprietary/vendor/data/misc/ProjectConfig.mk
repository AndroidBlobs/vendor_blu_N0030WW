...
#prize modify by zhuzhengjiang for camera 20181210 start
CUSTOM_HAL_IMGSENSOR = imx499_mipi_raw s5k4h7yx_mipi_raw s5k5e9yx_mipi_raw
CUSTOM_HAL_LENS = dw9714af dw9800waf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = s5k5e9yx_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af
CUSTOM_HAL_MAIN_IMGSENSOR = imx499_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9800waf
CUSTOM_HAL_MSENSORLIB = vtclib
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = ad5820af
CUSTOM_HAL_SUB_IMGSENSOR = s5k4h7yx_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = imx499_mipi_raw s5k4h7yx_mipi_raw s5k5e9yx_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = yes
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9714af dw9800waf dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR = s5k5e9yx_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9714af
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx499_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9800waf
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k4h7yx_mipi_raw
#prize modify by zhuzhengjiang for camera 20181210 end
...
CUSTOM_MODEM = k6309u2a-LWTG_R3_6771-3M-G4W12458F12357812131728-V0.313
...
PRIZE_AUDIO_AWINIC_MEC_SKT = yes
...
#prize modify  for dual camera 20190313 by zhuzhengjiang start
MTK_CAM_STEREO_CAMERA_SUPPORT = yes
#prize modify  for dual camera 20190313 by zhuzhengjiang end
...
#prize modify by wuliang 20190220 yes
...
#prize modify by lijimeng def no 20181130 start
MTK_CTA_SET = no
#prize modify by lijimeng def no 20181130 end
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#prize-wuliang-20181206 blu default en
...
#prize-enable mtklog-lanwm-20180830-begin
MTK_LOG_CUSTOMER_SUPPORT = yes
#prize-enable mtklog-lanwm-20180830-end
...
#prize modify wuliang 20190604 blu
...
#prize modified by lanwm,enable signature-20190128-begin
MTK_SIGNATURE_CUSTOMIZATION = yes
#prize modified by lanwm,enable signature-20190128-end
...
#prize modify by chenliang 20190515
...
PRIZE_TOUCH_GOODIX_GT9886 = yes
PRIZE_FINGER_PRINT = gw9518_tee
MTK_CW2015_SUPPORT = yes
MICROTRUST_THH_SUPPORT = yes
MICROTRUST_FINGERPRINT_SUPPORT = yes

#---------------------------工厂测试----------------------------------
#校准结果信息是否使用0.1来表示，yes：使用0.1表示，no：使用 未校准/已校准，默认为no
PRIZE_FACTORY_CALIBRATION_SHOW_01 = no
#重力校准(参考值为yes或者no,yes:应用编入到系统,no:不编译)
PRIZE_HOR_CALI = no
#整机测试是否测试蓝牙 wifi Gps
PRIZE_FACTORY_TEST_WBG = no
#自动化测试开关(参考值为yes或者no,yes:应用编入到系统,no:不编译)
PRIZE_AUTOTEST_APP = no
#PrizeBandMode开关(PCBA才会有要求，其他项目组，一律为no)
PRIZE_BANDMODE_APP = no
#功能键定义,支持选项:
#[NONE,MUTE,CUSTOM,SOS,PTT_RECORD,CAMERA,POWER,HOME,BACK,MENU,ONEKEY]
PRIZE_FUNCTION_KEY    =NONE
#工厂测试是否显示语言切换按钮
PRIZE_DEL_LAN_SWITCH_BTN =yes
#工厂测试应用默认英语
PRIZE_FACTORYTEST_DEFAULT_LANGUAGE_EN=no
#8801 显示TEE信息no或者其他非1.2.3的字符为不显示(如需要显示tee信息，根据厂商划分 必须要填入数字1或者2或者3，1:瓶玻，2:豆荚，3:墩泰)
PRIZE_TEE=2
#LED 测试(参考值为yes或者no,yes:系统存在硬件,no:没有此硬件)
PRIZE_LED=no
#LED 紫外测试(参考值为yes或者no,yes:系统存在硬件,no:没有此硬件)
PRIZE_LED_YC=no
#前摄闪光灯测试(参考值为yes或者no,yes:系统存在硬件,no:没有此硬件)
PRIZE_TORCH_FRONT=no
#Hall 霍尔测试(参考值为yes或者no,yes:系统存在硬件,no:没有此硬件)
PRIZE_HALL=yes
#无线充电测试(参考值为yes或者no,yes:系统存在硬件,no:没有此硬件)
PRIZE_WIRELESS_CHARGER=yes
#OTG 测试(参考值为yes或者no,yes:系统存在硬件,no:没有此硬件)
PRIZE_OTG_TEST = yes
#频段配置根据ProjectConfig.mk文件中的MTK_PROTOCOL1_RAT_CONFIG 系统频段配置
PRIZE_BOARD_NETWORK_TYPE = LfB/WB/GB
#配置工厂测试类型(按项目组划分，odm:ODM组，koobee:酷比国内，pcba-sea:pcba海外，pcba-china:pcba国内，不填或者没有宏则8801按照工厂的全工位NV显示包括校准和综测)
PRIZE_CUSTOMER=BLU
#64位老化ddr测试,关闭就无ddr测试项
PRIZE_64B_PROJECT=no
#副麦克风
PRIZE_DUAL_MIC_SUPPORT=yes
#真双摄副后摄测试项
PRIZE_FACTORY_TEST_REAR_CAMERA_SUB=yes
#---------------------------------工厂测试--------------------------------------
